...
import { useFoldersAllStore } from '@/stores/foldersAllStore';
import { spacing } from '@/styles/tokens';
import { useColors } from '@/styles/theme';

export default function FoldersAllScreen() {
  const colors = useColors();
  const router = useRouter();
  const { isLoading, error, folders, load, openFolder } = useFoldersAllStore();
